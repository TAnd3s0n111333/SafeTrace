...
"[project]/node_modules/react-fps-stats/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function FPSStats(_ref) {
    ...
    var _useReducer = (0, _react.useReducer)(function(state) {
        ...
        if (currentTime > state.prevTime + 1000) {
            var nextFPS = [].concat(_toConsumableArray(new Array(Math.floor((currentTime - state.prevTime - 1000) / 1000)).fill(0)), [
                Math.max(1, Math.round(state.frames * 1000 / (currentTime - state.prevTime)))
            ]);
            return {
                max: Math.max.apply(Math, [
                    state.max
                ].concat(_toConsumableArray(nextFPS))),
        ...
        prevTime: Date.now(),
        fps: []
    }), _useReducer2 = _slicedToArray(_useReducer, 2), state = _useReducer2[0], dispatch = _useReducer2[1];
    ...
    var fps = state.fps, max = state.max, len = state.len;
...
FPSStats.propTypes = {
    ...
    graphHeight: _propTypes["default"].oneOfType([
        _propTypes["default"].string,
        _propTypes["default"].number
    ]),
    graphWidth: _propTypes["default"].oneOfType([
        _propTypes["default"].string,
        _propTypes["default"].number
    ])
};
...
//# sourceMappingURL=_8760075e._.js.map